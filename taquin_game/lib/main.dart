...
class _Exo7State extends State<Exo7> {
  ...
  // Génère les tuiles et mélange le plateau
  void _generateTiles() {
    setState(() {
      ...
      // Place la tuile vide en bas à droite
      emptyTileIndex = gridSize * gridSize - 1;
      tiles[emptyTileIndex] = Tile.empty();
      // Mélange les tuiles (sauf la tuile vide)
      _shuffleTiles(20);
      moveCount = 0;
      isSolved = false;
      history.clear();
  ...
  // Mélange les tuiles en effectuant des déplacements valides
  ...
  // Retourne les indices des tuiles adjacentes à la tuile vide
  ...
  // Déplace une tuile si elle est adjacente à la tuile vide
...
class Tile {
  ...
  // Découpe l'image en fonction de la position de la tuile
